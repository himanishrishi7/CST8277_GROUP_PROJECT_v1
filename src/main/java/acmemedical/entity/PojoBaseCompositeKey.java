 ...
 */
// PC01 - Add annotation to define this class as superclass of all entities.  Please see Week 9 lecture slides.
// PC02 - Add annotation to place all JPA annotations on fields.
// PC03 - Add annotation for listener class.
@MappedSuperclass
...
public abstract class PojoBaseCompositeKey<ID extends Serializable> implements Serializable {
	...
	//  PC04 - Add missing annotations.
	@Version
	protected int version;

	//  PC05 - Add missing annotations (hint, is this column on DB?).
	@Basic
	@Column(name = "created")
	protected LocalDateTime created;

	//  PC06 - Add missing annotations (hint, is this column on DB?).
	@Basic
	@Column(name = "updated")
